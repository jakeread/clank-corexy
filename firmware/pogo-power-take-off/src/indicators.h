...
#define DEBUG1PIN_SETUP PIN_SETUP_OUTPUT(1, 7); PIN_HI(1, 7)
...
#define DEBUG2PIN_SETUP PIN_SETUP_OUTPUT(1, 6); PIN_HI(1, 6)
...
#define DEBUG3PIN_SETUP PIN_SETUP_OUTPUT(0, 3); PIN_HI(0, 3)
...
#define DEBUG4PIN_SETUP PIN_SETUP_OUTPUT(1, 11); PIN_HI(1, 11)